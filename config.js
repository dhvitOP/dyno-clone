...
module.exports = {
    "registercommands" : false,
     "token": "OTE2MzMzMjc1MTM0NDU1ODM4.Yaon3Q.SAJgJN8s16rlSAFDATq48Hz0Y4M",
...
defaultleavemessage: "{user} Left, Invited by {inviter}",
  basiclang: "en", //The basic language of the bot, "fr" for French and "en" for English
    ...
    auth: {
        support: "https://dsc.gg/vansmpnetwork", //The link of your Discord server
